...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='sykcoin.conf'
CONFIGFOLDER='/root/.sykcoin'
COIN_DAEMON='sykcoind'
COIN_CLI='sykcoin-cli'
COIN_TX='sykcoin-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/sykcoin/wallet/releases/download/1000/linux.zip'
COIN_BOOTSTRAP='https://github.com/sykcoin/syk/releases/download/1000/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='sykcoin'
COIN_NAME_OLD='sykcoind'
PROJECT_NAME='SyKcoin (syk)'
COIN_EXPLORER='http://explorer.sykcoin.com/'
COIN_PORT=4468
RPC_PORT=4467
...
cat << EOF > /root/sykcoin-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sykcoin-general-info

cat << EOF > /root/sykcoin-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sykcoin-fee-info

cat << EOF > /root/sykcoin-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sykcoin-networkinfo

cat << EOF > /root/sykcoin-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/sykcoin-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/sykcoininfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias sykcoininfo='/root/sykcoin-general-info'" >> /root/.bashrc
echo -e "alias feestats='/root/sykcoin-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/sykcoin-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/sykcoin-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}sykcoin-cli getinfo${NC}, ${RED}sykcoin-cli getnetworkinfo${NC}, ${RED}sykcoin-cli getconnectioncount${NC}commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
